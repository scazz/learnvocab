...
namespace Scazz\LearnVocabBundle\DependencyInjection\Security\Factory;
...
class AuthFactory implements SecurityFactoryInterface
{
	public function create(ContainerBuilder $container, $id, $config, $userProvider, $defaultEntryPoint)
	{
		...
		$listener = $container->setDefinition($listenerId, new DefinitionDecorator('auth.security.authentication.listener'));
